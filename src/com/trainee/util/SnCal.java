...
import com.trainee.common.Common;
import com.trainee.common.UrlCommon;
...
public class SnCal {
	...
	public String getSN(Map paramsMap) throws UnsupportedEncodingException{
		String paramsStr = toQueryString(paramsMap);
		String wholeStr = new String(UrlCommon.WEATHERURL+"?" + paramsStr + Common.BAIDUAK);
		return null;
	}
